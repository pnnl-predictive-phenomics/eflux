...
@pytest.fixture(
    name="expected_eflux3_output",
)
def expected_eflux3_output():
    """Fixture for expected eflux3 output dataframe."""
    expected_output = pd.DataFrame(
        {
            "strain1": [0.01, 0.01, 0.01, 0.01],
            "strain2": [0.01, 0.01, 0.01, 0.01],
        },
        index=["r1", "r2", "r3", "r4"],
    )
